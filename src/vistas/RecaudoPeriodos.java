...
public class RecaudoPeriodos extends javax.swing.JFrame {
     ...
     */
    public RecaudoPeriodos() {
        initComponents();
        setTitle("Valor recaudado");
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RecaudoPeriodos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RecaudoPeriodos().setVisible(true);
            }
        });
    }
